...
insert into chart (id,song,artist,release) values ( 1,"A","Aa","1" );
insert into chart (id,song,artist,release) values ( 2,"B","Bb","2" );
insert into chart (id,song,artist,release) values ( 3,"C","Cc","3" );
insert into chart (id,song,artist,release) values ( 4,"D","Dd","4" );
